...
Aunque en [este tweet](https://twitter.com/matthiasgomolka/status/1404821668695007237) se dice que si puedes llevar el objeto de la izquierda a un argumento distinto del primero, si los anteriores argumentos tienen puesto el nombre, ya que "The pipe pipes into the first unnamed argument, I guess."
