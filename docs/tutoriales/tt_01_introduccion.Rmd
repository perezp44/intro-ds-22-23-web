...
En [este post](https://www.enriquedans.com/2021/09/el-open-source-como-base-de-la-competitividad-europea.html) se plantea que el "open source" puede ser clave para la competitividad en la UE. Para aquellos que creen que el software comercial da más garantías, pueden leerse [este post](https://notstatschat.rbind.io/2019/02/18/absolutely-no-warranty/).
