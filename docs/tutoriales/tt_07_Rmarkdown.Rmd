...
```{r, echo = FALSE, fig.asp = 7/9}
tweetrmd::tweet_embed("https://twitter.com/andrewheiss/status/1443570972703936523", theme = "light", align = "center", dnt = TRUE, maxwidth = 900)
```
...
- Podemos [usar iconos](https://ropensci.org/technotes/2018/05/15/icon/) en nuestros Rmds. Por ejemplo: `r icons::icon_style(icons::fontawesome("rocket"), fill = "#1FA67A")` + 
`r icons::icon_style(icons::fontawesome("r-project"), fill = "#384CB7")` = 
`r icons::icon_style(icons::fontawesome("heart"), fill = "red")`
...
- Incorporando algunas opciones al YAML, se pueden cambiar algunos aspectos de tu documento html. Puedes verlo [aquí](https://bookdown.org/yihui/rmarkdown/html-document.html#appearance-and-style.)
...
- El paquete [fontawesome](https://github.com/rstudio/fontawesome) permite incluir iconos de [**Font Awesome**](https://fontawesome.com/) en documentos RMarkdown. Por ejemplo con `` ` fontawesome::fa("r-project", fill = "steelblue")` ``   podemos insertar el icono de `r fontawesome::fa("r-project", fill = "steelblue")` 
