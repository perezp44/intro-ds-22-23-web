...
- [**Foros del curso**](https://github.com/perezp44/intro-ds-21-22-web-companion/discussions){target="_blank"}: un espacio para resolver preguntas sobre el curso y las tareas para casa. 

- [**Wiki del curso**](https://github.com/perezp44/intro-ds-21-22-web-companion/wiki){target="_blank"}: una wiki asociada al curso para hacer unos **apuntes colaborativos** y [registrar las erratas](https://github.com/perezp44/intro-ds-21-22-web-companion/wiki/Erratas){target="_blank"} que vayáis encontrando en los materiales del curso. 


##### Para recoger las tareas

- [**Uploader**](https://driveuploader.com/upload/LSuDu082xZ/){target="_blank"}: Un servicio que utilizaré para recoger vuestros trabajos. Ya os diré como funciona. Lo abriré cuando tenga que recoger trabajos.
...
- [**Aula Virtual de la asignatura**](https://aulavirtual.uv.es/course/view.php?id=29740){target="_blank"}: como Aula Virtual es el sitio oficial de la asignatura colgaré allí los anuncios de tipo "oficial". También colgaré en Aula Virtual los detalles sobre la evaluación. Además, si hiciera falta, allí podemos organizar reuniones virtuales a través de BBC (Black Board Collaborate).


##### Fácil que los usemos menos, pero per si de cas, aquí están:

- [**RStudio Cloud Project**](https://rstudio.cloud/project/2860324){target="_blank"}: El año pasado este recurso nos resulto muy útil, pero ahora la versión gratuita tiene límite de tiempo, aunque de momento yo sí lo estoy usando para dar clase en el aula.


- [**Jitsi link to make e-meetings**](https://meet.jit.si/intro-to-DS_UV_2020-21){target="_blank"}: Una room de Jitsi para hacer reuniones online. Seguramente la utilizaremos para las tutorías online.

- [Screenleap](https://www.screenleap.com/){target="_blank"}: Por si nos hace falta compartir pantalla. 
...
- [**Guiones de clase/Ejemplos/Ejercicios**](06-mas-cosas.html):  iré colgando conforme avancen las clases.
