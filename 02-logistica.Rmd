...
- [**Foros del curso**](https://github.com/perezp44/intro-ds-22-23-web-companion/discussions){target="_blank"}: un espacio para resolver preguntas sobre el curso y las tareas para casa. 
