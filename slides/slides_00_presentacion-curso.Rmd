...
- Hablar un poco de **nosotros** y del curso.

- Hablar un poco más del **curso**: Objetivo, contenidos y estructura

--

- Primeras ideas del **Tema 1**.

- **Instalación** de R, RStudio y paquetes.

- Primeros **ejemplos**.

- **Worflow** y más ejemplos.
...
Teneis toda la información en la [página web del curso](https://perezp44.github.io/intro-ds-21-22-web/)
...
- 40% evaluación continua, 60% examen.
...
- Más detalles en la página web del curso: <https://perezp44.github.io/intro-ds-21-22-web/>
...
- Aun así, he preparado un conjunto de **tutoriales**, **ejemplos** y **casos** que podrás descargar en varios sitios:
  ...
  - Los ejemplos y casos los puedes descargar en ....



## Para comenzar el curso haremos: 
...
> - Hablar de la **forma de trabajar** con R (ó workflow): scripts, Rprojects, .Rmd
